    ...
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_18rem]">
        <article>
          ...
          <div
            className={cn(
              'relative mt-8 aspect-[21/9] overflow-hidden rounded-3xl bg-gradient-to-br shadow-soft',
          ...
          <div className="prose-article mx-auto mt-10 max-w-3xl">
            ...
            {article.sources && article.sources.length > 0 ? (
              <div className="not-prose mt-8 rounded-2xl border border-line bg-mist/40 p-5">
                <p className="text-xs font-semibold uppercase tracking-[0.16em] text-sage">Sources primaires</p>
                ...
                <p className="mt-3 text-xs text-ink-soft">
                  Synthèse originale MediaCBD. Les textes complets restent sur les sites sources.
                </p>
              </div>
            ) : null}
            <blockquote>
